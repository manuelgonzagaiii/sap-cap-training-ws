...
class MaintenanceService extends cds.ApplicationService {
  async init() {
    ...
    // Bound action with a parameter and a return value: add `by` to the part's stock.
    ...
    // Unbound function: count spare parts whose stock is below their reorder level.
